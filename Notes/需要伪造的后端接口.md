...
|    id    |    string     |    分类id    |    是    |
|   name   |    string     |   分类名字   |    是    |
| picture  |    string     |   分类图片   |    是    |
| children | array[object] |  子分类数组  |    是    |
|  goods   | array[object] | 分类下属商品 |    是    |

`result/children`

|   字段   |  类型  |          备注          | 是否必须 |
| :------: | :----: | :--------------------: | :------: |
|    id    | string |     二级分类菜单id     |    是    |
|   name   | string |      二级分类名字      |    是    |
| picture  | string |      二级分类图片      |    是    |
| children |  null  |   三级分类数组(暂无)   |    是    |
|  goods   |  null  | 二级分类商品数组(暂无) |    是    |
...
|   desc   | string |           商品描述           |    是    |
|  price   | string |           商品价格           |    是    |
| picture  | string |           商品图片           |    是    |
| discount |  null  | 商品折扣(如为null，即无折扣) |    是    |
| orderNum |  null  |           商品销量           |    是    |
...
| :-----: | :----: | :--------------: | :------: |
|   id    | string |      品牌id      |    是    |
|  name   | string |   品牌中文名字   |    是    |
| nameEn  | string |   品牌英文名字   |    是    |
|  logo   | string | 品牌logo图片地址 |    是    |
| picture | string |   品牌图片地址   |    是    |
|  type   |  null  |  品牌类型(暂无)  |    是    |
|  desc   | string |     品牌描述     |    是    |
|  place  | string |     品牌产地     |    是    |
...
|       字段       |  类型  |                   备注                   | 示例 | 是否必须 |
| :--------------: | :----: | :--------------------------------------: | :--: | :------: |
| distributionSite | string | 广告区域位置(1 首页，2商品分类页)，默认1 |  1   |    否    |
...
| :-----: | :----: | :---------------------------------------------: | :------: |
|   id    | string |                    轮播图id                     |    是    |
| imgUrl  | string |                   轮播图地址                    |    是    |
| hrefUrl | string |                 轮播图调转链接                  |    是    |
|  type   | string | 轮播图跳转类型<br>1、页面<br>2、H5<br>3、小程序 |    是    |
...
| 字段  |  类型  |                 备注                  | 示例 | 是否必须 |
| :---: | :----: | :-----------------------------------: | :--: | :------: |
| limit | string | 需要的数据条数(默认4个后台设置返回的) |  4   |    否    |
...
| :------: | :-----------: | :----------: | :------: |
|    id    |    string     |  一级分类id  |    是    |
|   name   |    string     | 一级分类名字 |    是    |
| picture  |    string     | 一级分类图片 |    是    |
| children | array[object] |  子分类数组  |    是    |
...
|      name      |    string     |     二级分类名字     |    是    |
|    picture     |    string     |     二级分类图片     |    是    |
|    parentId    |     null      |  二级分类父级分类id  |    是    |
|   parentName   |     null      | 二级分类父级分类名字 |    是    |
|     goods      | array[object] |     二级分类商品     |    是    |
|   categories   |     null      |       分类集合       |    是    |
|     brands     |     null      |       推荐品牌       |    是    |
| saleProperties |     null      |       销售属性       |    是    |
